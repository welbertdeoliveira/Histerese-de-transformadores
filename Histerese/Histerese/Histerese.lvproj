...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Histerese Message Queue.lvlib" Type="Library" URL="../support/Message Queue/Histerese Message Queue.lvlib"/>
			<Item Name="Histerese User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/Histerese User Event - Stop.lvlib"/>
			<Item Name="Histerese Set Enable State on Multiple Controls.vi" Type="VI" URL="../support/Histerese Set Enable State on Multiple Controls.vi"/>
			<Item Name="Histerese Check Loop Error.vi" Type="VI" URL="../support/Histerese Check Loop Error.vi"/>
			<Item Name="Histerese Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/Histerese Error Handler - Event Handling Loop.vi"/>
			<Item Name="Histerese Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/Histerese Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Histerese Acquired Data.ctl" Type="VI" URL="../controls/Histerese Acquired Data.ctl"/>
			<Item Name="Histerese UI Data.ctl" Type="VI" URL="../controls/Histerese UI Data.ctl"/>
			<Item Name="Histerese UI State.ctl" Type="VI" URL="../controls/Histerese UI State.ctl"/>
		</Item>
		<Item Name="Histerese Acquisition.lvlib" Type="Library" URL="../Acquisition/Histerese Acquisition.lvlib"/>
		<Item Name="Histerese Logging.lvlib" Type="Library" URL="../Logging/Histerese Logging.lvlib"/>
		<Item Name="Histerese Settings.lvlib" Type="Library" URL="../Settings/Histerese Settings.lvlib"/>
		<Item Name="Histerese Main.vi" Type="VI" URL="../Histerese Main.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Graph As Chart.vi" Type="VI" URL="../../../Graph As Chart.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Continuous Measurement and Logging Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Histerese Main.vi</Property>
