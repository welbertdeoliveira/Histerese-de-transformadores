...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Logging Message Queue.lvlib" Type="Library" URL="../support/Message Queue/Logging Message Queue.lvlib"/>
			<Item Name="Logging User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/Logging User Event - Stop.lvlib"/>
			<Item Name="Logging Set Enable State on Multiple Controls.vi" Type="VI" URL="../support/Logging Set Enable State on Multiple Controls.vi"/>
			<Item Name="Logging Check Loop Error.vi" Type="VI" URL="../support/Logging Check Loop Error.vi"/>
			<Item Name="Logging Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/Logging Error Handler - Event Handling Loop.vi"/>
			<Item Name="Logging Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/Logging Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Logging Acquired Data.ctl" Type="VI" URL="../controls/Logging Acquired Data.ctl"/>
			<Item Name="Logging UI Data.ctl" Type="VI" URL="../controls/Logging UI Data.ctl"/>
			<Item Name="Logging UI State.ctl" Type="VI" URL="../controls/Logging UI State.ctl"/>
		</Item>
		<Item Name="Logging Acquisition.lvlib" Type="Library" URL="../Acquisition/Logging Acquisition.lvlib"/>
		<Item Name="Logging Logging.lvlib" Type="Library" URL="../Logging/Logging Logging.lvlib"/>
		<Item Name="Logging Settings.lvlib" Type="Library" URL="../Settings/Logging Settings.lvlib"/>
		<Item Name="Logging Main.vi" Type="VI" URL="../Logging Main.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Continuous Measurement and Logging Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Logging Main.vi</Property>
